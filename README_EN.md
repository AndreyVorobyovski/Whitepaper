...
*Nousprotocol allows swift creation of all types of investment funds to manage blockchain assets. Funds are equipped with complete required technology tools to manage portfolios and are accountable and transparent with the investors. To calculate the volume of the capital Nousplatform uses the equivalent in Nous Tokens. Investors use Nous Tokens to conduct any transaction for purchase or sale of the fund equity assets. One of the advantages for open-ended funds is the ability to redeem the equity shares from investors with the Nous Tokens held by the fund in portfolio reserves. In this case, the fund does not need to sell the equity assets in order to payout to the investor. This mechanism will create positive growth dynamics by increasing the liquidity of the funds.
